...
### Manual-session prep and post-diff helpers
...
These close the gap between the probe manifests and the eventual human Serum
capture pass:
...
- `run_serum_vst2_postdiff.py` turns a completed pair folder into a persistent
  ingest artifact plus a readable summary/next-actions packet.
